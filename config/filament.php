...
use Monet\Framework\Auth\Avatar\AvatarProvider;
use Monet\Framework\Auth\Http\Middleware\Authenticate;
use Monet\Framework\Auth\Http\Middleware\EnsureEmailIsVerifiedIfRequired;
...
return [
    ...
    */
    ...
    'default_avatar_provider' => AvatarProvider::class,
    ...
    */
    ...
    'google_fonts' => 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&display=swap',
